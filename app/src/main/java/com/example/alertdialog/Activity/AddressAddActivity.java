            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    try {
                        ...
                        String expressUrl = "http://10.166.1.155:8080/REST/Misc/AddressList/saveAddressByCustomerId?param=" + encodedString + "&id=" + customerId + "&regioncode=" + regioncode + "&name=" + newName + "&tel=" + newTel;
