            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    try {
                        ...
                        String expressUrl = "http://10.10.11.27:8080/REST/Misc/AddressList/saveAddressByCustomerId?param=" + encodedString + "&id=" + customerId + "&regioncode=" + regioncode + "&name=" + newName + "&tel=" + newTel;
